...
pub fn passkey_hash_signature_response_format_bytes(
    ...
    println!("XDB - utils::passkey::passkey_hash_signature_response_format - passkey_response: {:?}", passkey_response);
    println!("XDB - utils::passkey::passkey_hash_signature_response_format - contracts: {:?}", contracts);
    ...
    let s = normalize_s::normalize_s(unwrapped_sig.s)?;
    println!("XDB - Normalized s: {:?}", s);
