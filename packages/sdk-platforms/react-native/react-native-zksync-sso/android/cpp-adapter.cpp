...
// Automated testing checks Java_com_zksyncsso_ZksyncSsoModule and zksyncsso
...
// Installer coming from ZksyncSsoModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_zksyncsso_ZksyncSsoModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return zksyncsso::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_zksyncsso_ZksyncSsoModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return zksyncsso::cleanupRustCrate(*runtime);
}